...
def check_calculating_results(results_dic, results_stats_dic):
    ...
    if results_stats_dic is None:
        ...
        for key in results_dic:
            pet_label_is_dog = results_dic[key][3] if key in results_dic else 0
            classifier_label_is_dog = results_dic[key][4] if key in results_dic else 0
            is_match = results_dic[key][2] if key in results_dic else 0
